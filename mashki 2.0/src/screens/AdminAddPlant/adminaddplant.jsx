...
const AdminAddPlant = () => {
  ...
  const fetchWaterPlants = async () => {
    try {
      ...
      const response = await axios.get('http://192.168.100.10:5000/admin/water-plants');
  ...
  const handleAddWaterPlant = async () => {
    try {
      ...
      const response = await axios.post('http://192.168.100.10:5000/admin/add-water-plant', {
        name,
        address,
  ...
  const handleDeleteWaterPlant = async (phoneNumber) => {
    try {
      ...
      const response = await axios.delete(`http://192.168.100.10:5000/admin/delete-water-plant/${phoneNumber}`);
      if (response.status === 200) {
